...
public:
    ...
    void animationEndedCallbackHandler2(
        const touchgfx::AnimatedImage& src);
    // void animationEndedCallbackHandler(const & src);
    void setupTextureMapper(TextureMapper& hand, Image* image);
    void setupAnimation(AnimatedImage& animatedImage);
...
protected:
    ...
    SkipRect<AnimatedImage> animatedImage2;
   ...
   */
    ...
    Callback<Screen1View, const AnimatedImage&> animationEndedCallback2;
    // Callback<Screen1View, const AnimatedImage&> animatedImage_animationEndedCallback;
    int tickCounter;
